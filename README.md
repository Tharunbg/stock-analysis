...
- Creating dashboard - Historical Performance page.
...
That will provide access to a Json file.
...
In the menu we copy the URL. We can change the Ticker for the financial instrument we want, in this case we will use AMZN (Amazon), but it can be any. Where it says "YOUR API KEY" we must delete that and place the Key that was assigned to us.
...
## About the Developer
This project is maintained by Tharun Kumar Bettadalli Girish. Tharun is a Data Scientist with over 4 years of professional experience in data analysis, visualization, and engineering. His technical expertise includes Python, SQL, PySpark, R, Spark, Databricks, and HDFS.

- GitHub: https://github.com/Tharunbg
- LinkedIn: https://www.linkedin.com/in/tharungirish10/
- Email: tharungirish10@gmail.com